...
public partial class CMSModules_Ecommerce_FormControls_BentleyOptionCategoryProductOptionSelector : FormEngineUserControl
{
    #region "Variables"
    ...
    private bool SelectedTextCategory
    {
        ...
        {
            // Custom Trevor Fayas
            return (SelectionType == OptionCategorySelectionTypeEnum.TextArea) || (SelectionType == OptionCategorySelectionTypeEnum.TextBox) || (SelectionType == OptionCategorySelectionTypeEnum.FormControl);
            // End Custom
        }
    }
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        {
            bool wasTextCategory = (PreviouslySelectedSelectionType == OptionCategorySelectionTypeEnum.TextArea) || (PreviouslySelectedSelectionType == OptionCategorySelectionTypeEnum.TextBox) || (PreviouslySelectedSelectionType == OptionCategorySelectionTypeEnum.FormControl);
    ...
    protected void PrepareSelectionControl()
    {
        ...
        switch (SelectionType)
        {
            ...
            case OptionCategorySelectionTypeEnum.FormControl:
                txtText.TextMode = TextBoxMode.SingleLine;
                lblTextBoxLabel.Text = "Set the path to the Form Control here<br/>";
                lblTextBoxLabel.Visible = true;
                break;
                // End Custom
        }
