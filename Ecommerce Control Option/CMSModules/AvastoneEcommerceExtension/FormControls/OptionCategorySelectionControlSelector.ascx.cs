...
public partial class CMSModules_AvastoneEcommerceExtension_FormControls_OptionCategorySelectionControlSelector : FormEngineUserControl
{
    ...
    private List<string> GetExcludedOptions(OptionCategoryTypeEnum optionCategoryType)
    {
        ...
        // Custom Trevor Fayas - We want this added, so don't exclude it.
